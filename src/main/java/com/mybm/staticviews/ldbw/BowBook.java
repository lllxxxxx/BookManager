 ...
 * @date: 2022/5/8 20:16
 */
public class BowBook extends JFrame {
    ...
    public BowBook(String s){
        super(s);
        this.setSize(600,700);
        String[] s1=new String[]{"读者编号","读者姓名","读者类别"};
        String[] s2=new String[]{"图书编号","图书名称","借书日期"};
        String[] s4=new String[]{"借阅","关闭"};
        String[] s3=new String[]{"ISBN","类别","书名","作者","出版社","出版日期","印刷次数","单价","当前日期","操作人员"};
        Object[][] o=null;
        ...
        ps[2].setLayout(new GridLayout(5,4,10,10));
